/*------------------------------------------------------------------------------------*/
//
//  TestWWOZEventsViewController.m
//  iNewOrleans
//
...
#import "TestWWOZEventsDetailsViewController.h"
#import "RequestManager.h"

/*------------------------------------------------------------------------------------*/

@interface TestWWOZEventsViewController() < UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate >
...
@implementation TestWWOZEventsViewController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
	...
	{
		return ((AppDelegate*)[AppDelegate sharedDelegate]).wwozDateEventsDict.allKeys.count;
	}
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSDictionary * dict = ((AppDelegate*)[AppDelegate sharedDelegate]).wwozDateEventsDict;
	if (self.filteredVenuesDict)
	{
...
- (void)selectTableViewRow:(UITableView*)tableView indexPath:(NSIndexPath*)indexPath
{
	...
	TestWWOZEventsDetailsViewController * controller = [[TestWWOZEventsDetailsViewController alloc] initWithNibName:@"TestWWOZEventsDetailsViewController" bundle:nil];
...
- (void)filterByString:(NSString*)a_filter
{
	...
	{
		for (id key in [((AppDelegate*)[AppDelegate sharedDelegate]).wwozDateEventsDict allKeys])
		{
			NSDictionary * dict = [((AppDelegate*)[AppDelegate sharedDelegate]).wwozDateEventsDict objectForKey:key];
